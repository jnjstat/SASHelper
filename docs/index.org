...
#+TAGS: Window Library Filter Variables Frequency Find Sort Option Shortcuts Dataset
...
* How-to Guide
** How to subset a single dataset?                          :Filter:Dataset:
...
** How to Clear the dataset filter?      :Filter:Dataset:
...
** How to undo the Dataset Filter?                           :Filter:Dataset:
...
** How to know the current dataset filter?                   :Filter:Dataset:
...
** How to change the default logical operator from AND to OR while subsetting? :Filter:Dataset:
...
** How to Subset on all the datasets in a library?           :Filter:Library:
...
** How to know the current library filter?                   :Filter:Library:
The library filter is shown in the Status Bar at the bottom of the screen in red color.

** How to Clear the library filter?                          :Filter:Library:
...
** How to get frequencies of values of one variable?              :Frequency:
...
** How to get frequencies of values of multiple variables (crosstabulation)? :Frequency:
...
** How to get frequencies of distinct USUBJIDs of one variable?   :Frequency:
...
** How to get frequencies of distinct USUBJIDs of multiple variables (crosstabulation)? :Frequency:
- Holding Ctrl to select multiple cells. One varialbe, one cell.
- Right click on one of the selected cells
- Choose "Frequency (USUBJID)" from the context menu

** How to use the Frequency window to help with subsetting? :Frequency:Filter:
...
** How to Hide/Unhide variables from the Variables window?        :Variables:
...
** How to Hide variables from the Dataset window?                   :Dataset:
...
** How to Hide all variables from the Variables window?           :Variables:
...
** How to Unhide all variables from the Variables window?         :Variables:
...
** How to Unhide all variables from the Dataset window?           :Dataset:
...
** How to Sort variable list?                                     :Variables:
...
** How to Go to a variable quickly from the Variables window?     :Variables:
...
#+END_info
** How to look up a variable's metadata from the Dataset window?    :Dataset:
...
** How to Reorder the variables from the Variables window?        :Variables:
...
** How to Reorder the variables from the Dataset window?          :Variables:
*** Shift Variable Left
...
** How to show a specific window?                        :Window:
...
** How to show the Variables window quickly?                         :Window:
...
** How to dock and float a specific window?                          :Window:
...
** How to view one dataset in two separated tabs?                    :Window:
...
** How to add a Library to the Workspace?                           :Library:
...
** How to remove libname for a library?                             :Library:
- Right click on the library
- Choose "Set Libname" and a dialog window "SAS Helper - Library Alias" will show
- Delete the library name and click OK button

** How to Watch File Changes?                                       :Library:
...
** How to Open New Dataset Automatically?                           :Library:
...
** How to View Dataset Variables like SAS Universal Viewer?         :Library:
...
** How to enter the Library filter manually?                 :Filter:Library:
...
** How to enter the Dataset filter manually?                 :Filter:Dataset:
...
** How to quickly locate a variable by finding the variable name?      :Find:
...
** How to set a different font(name, size, etc) for the dataset window? :Option:
- Click Edit -> Options
- Click "Font" button from the dialog window "SAS Helper Options"

** How to increase the font size quickly?       :Shortcuts:Dataset:
...
** How to decrease the font size quickly?                 :Shortcuts:Dataset:
Use the shortcut key Ctrl + -.
